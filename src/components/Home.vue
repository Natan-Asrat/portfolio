  ...
  <div class="container" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="row skills-content skills-animation">
      ...
      <div class="col-lg-6">
        ...
        <div class="progress">
          <span class="skill"><span>Vue.js | HTML | CSS | JavaScript</span> <i class="val">65%</i></span>
          <div class="progress-bar-wrap">
  ...
  <div class="container">
    ...
    <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
      ...
      <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
          <img src="/apps/location_collector/visualize_locations_mockup.png" class="img-fluid" alt="">
          <div class="portfolio-info">
            <h4>Location Collector and Viewer</h4>
            <p>Easily Collect, Save, and Visualize Your Locations!</p>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
          <img src="/apps/location_collector/direction_mockup.png" class="img-fluid" alt="">
          <div class="portfolio-info">
            <h4>Location Collector and Viewer</h4>
            <p>Easily Collect, Save, and Visualize Your Locations!</p>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
          <img src="/apps/natville_g12/physics_list_mockup.png" class="img-fluid" alt="">
          <div class="portfolio-info">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
          <img src="/apps/natville_g12/electromagnetism_mockup.png" class="img-fluid" alt="">
          <div class="portfolio-info">
            <h4>Natville Grade 12 Physics</h4>
            <p>I’m here to help grade 12 students with my Physics course!</p>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
          <img src="/apps/natville_g12/applications_mockup.png" class="img-fluid" alt="">
          <div class="portfolio-info">
            <h4>Natville Grade 12 Physics</h4>
            <p>I’m here to help grade 12 students with my Physics course!</p>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
          <img src="/apps/natville_freshman/choose_playlist_mockup.png" class="img-fluid" alt="">
          <div class="portfolio-info">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
          <img src="/apps/natville_freshman/maths_mockup.png" class="img-fluid" alt="">
          <div class="portfolio-info">
            <h4>Natville Freshman Tutor</h4>
            <p>I have covered Logic and Critical Thinking, Psychology, and Applied Mathematics One in my tutorials.</p>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
          <img src="/apps/natville_freshman/playing_mockup.png" class="img-fluid" alt="">
          <div class="portfolio-info">
            <h4>Natville Freshman Tutor</h4>
            <p>I have covered Logic and Critical Thinking, Psychology, and Applied Mathematics One in my tutorials.</p>
  ...
  <div class="row gy-4">
    ...
    <!-- <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100"> -->
      ...
      <div class="service-item item-cyan position-relative">
        ...
        <p>I specialize in building robust backend systems using Django, Flask, and Django REST Framework. I create scalable APIs that power mobile and web applications efficiently.</p>
      </div>
    ...
    <!-- <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200"> -->
      ...
      <div class="service-item item-orange position-relative">
        ...
        <p>I develop feature-rich Android applications using Java and integrate them with Firebase for user authentication, push notifications and remote config.</p>
      </div>
    </div><!-- End Service Item -->
    ...
    <!-- <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300"> -->
      ...
      <div class="service-item item-teal position-relative">
        ...
        <p>I integrate pre-trained machine learning models into applications using TensorFlow and LangChain, enabling AI-driven functionalities such as audio detection and pose estimation in real-time.</p>
      </div>
    </div><!-- End Service Item -->
    ...
    <!-- <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400"> -->
      ...
      <div class="service-item item-purple position-relative">
        ...
        <p>I build desktop applications using Java Swing and SQLite, tailored to meet your business requirements, providing a seamless experience on Windows.</p>
      </div>
    </div><!-- End Service Item -->
    ...
    <!-- <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500"> -->
      ...
      <div class="service-item item-blue position-relative">
        ...
        <a href="#" class="stretched-link">
          <h3>Vue.js Websites</h3>
        </a>
        <p>I develop dynamic, responsive websites using Vue.js and Bootstrap, creating interactive user interfaces and single-page applications that deliver an engaging user experience.</p>
      </div>
    </div><!-- End Service Item -->
    ...
    <!-- <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600"> -->
      ...
      <div class="service-item item-red position-relative">
        ...
        <p>I develop custom Python scripts to automate tasks, process data, and enhance workflows.</p>
      </div>
    </div><!-- End Service Item -->
